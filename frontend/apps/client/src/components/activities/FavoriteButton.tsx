...
export function FavoriteButton({
  ...
  return (
    <button
      ...
      className={cn(
        "absolute end-3top-3 flex items-center justify-center rounded-full bg-card/95 shadow-md transition-transform hover:scale-105",        size === "lg" ? "size-11" : "size-9",
        fav ? "text-blue-600" : "text-foreground/30",      )}
    >
