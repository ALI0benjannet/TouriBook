    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="animate-fade-up relative mx-auto max-w-7xl px-4 pb-24 pt-16 text-center sm:px-8">
          <span className="inline-block rounded-full border border-blue-100 px-4 py-1.5 text-[13px] font-semibold uppercase tracking-wider text-blue-100">            {fr.home.heroKicker}
          </span>
          <h1 className="font-display mx-auto mb-8 mt-7 w-full text-center text-4xl leading-[1.08] text-white sm:whitespace-nowrap sm:text-7xl">            {fr.home.heroTitle}
          </h1>
          <p className="jost mx-auto mb-10 w-full text-center text-lg font-normal leading-relaxed tracking-wide text-white/90 sm:whitespace-nowrap">            {fr.home.heroSub}
          </p>
          <HeroSearch />
        </div>
      </section>
